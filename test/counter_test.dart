...
//assert
    ...
    test(
        'Given Counter class is instantiated, when increamentCount is called, then count = 1',
        () {
//arrange
...
//assert
    ...
    test(
        'given Counter class is instantiated, when icreamentCount is called, then count = -1',
        () {
//arrange
